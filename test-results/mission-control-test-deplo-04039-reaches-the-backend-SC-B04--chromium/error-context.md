...
- Name: mission-control-test.spec.ts >> deploy config - alerts bug - toggle on never reaches the backend (SC-B04)
...
Expected: "paymentsapi"
Error: strict mode violation: locator('div').filter({ hasText: /^Service Name$/ }).locator('xpath=following-sibling::div[1]') resolved to 2 elements:
    1) <div>…</div> aka locator('div').filter({ hasText: 'Region' }).nth(4)
    2) <div></div> aka locator('body > div > div > div:nth-child(3) > div > div > div:nth-child(2)').first()
...
Expected: "eu-west-1"
Error: strict mode violation: locator('div').filter({ hasText: /^Region$/ }).locator('xpath=following-sibling::div[1]') resolved to 2 elements:
    1) <div>…</div> aka locator('div').filter({ hasText: 'Priority' }).nth(4)
    2) <div></div> aka locator('body > div > div > div:nth-child(3) > div > div:nth-child(2) > div:nth-child(2)')
...
Expected: "2"
Error: strict mode violation: locator('div').filter({ hasText: /^Priority$/ }).locator('xpath=following-sibling::div[1]') resolved to 2 elements:
    1) <div>…</div> aka getByText('Alerts EnabledNo')
    2) <div></div> aka locator('div:nth-child(3) > div > div:nth-child(3) > div:nth-child(2)')
...
Locator:  locator('div').filter({ hasText: /^Alerts Enabled$/ }).locator('xpath=following-sibling::div[1]')
Expected: "Yes"
Received: "No"
Timeout:  5000ms
...
Call log:
  - Expect "soft toHaveText" with timeout 5000ms
  - waiting for locator('div').filter({ hasText: /^Alerts Enabled$/ }).locator('xpath=following-sibling::div[1]')
    14 × locator resolved to <div>No</div>
       - unexpected value "No"
...
Locator: locator('div').filter({ hasText: /^Deployment Window$/ }).locator('xpath=following-sibling::div[1]')
Expected: "2026/09/01T09:00"
Error: strict mode violation: locator('div').filter({ hasText: /^Deployment Window$/ }).locator('xpath=following-sibling::div[1]') resolved to 2 elements:
    1) <div>…</div> aka locator('div').filter({ hasText: 'Alert Threshold' }).nth(4)
    2) <div></div> aka locator('div:nth-child(5) > div:nth-child(2)')

Call log:
  - Expect "soft toHaveText" with timeout 5000ms
  - waiting for locator('div').filter({ hasText: /^Deployment Window$/ }).locator('xpath=following-sibling::div[1]')
...
Locator: locator('div').filter({ hasText: /^Alert Threshold$/ }).locator('xpath=following-sibling::div[1]')
Expected: "10"
Error: strict mode violation: locator('div').filter({ hasText: /^Alert Threshold$/ }).locator('xpath=following-sibling::div[1]') resolved to 2 elements:
    1) <div>…</div> aka getByText('Notification Channels—')
    2) <div></div> aka locator('div:nth-child(6) > div:nth-child(2)')

Call log:
  - Expect "soft toHaveText" with timeout 5000ms
  - waiting for locator('div').filter({ hasText: /^Alert Threshold$/ }).locator('xpath=following-sibling::div[1]')
...
Locator:  locator('div').filter({ hasText: /^Notification Channels$/ }).locator('xpath=following-sibling::div[1]')
Expected: "Email"
Received: "—"
Timeout:  5000ms
...
Call log:
  - Expect "soft toHaveText" with timeout 5000ms
  - waiting for locator('div').filter({ hasText: /^Notification Channels$/ }).locator('xpath=following-sibling::div[1]')
...
Locator:  locator('div').filter({ hasText: /^Access Roles$/ }).locator('xpath=following-sibling::div[1]')
Expected: "Admin"
Received: "—"
Timeout:  5000ms
...
Call log:
  - Expect "soft toHaveText" with timeout 5000ms
  - waiting for locator('div').filter({ hasText: /^Access Roles$/ }).locator('xpath=following-sibling::div[1]')
    14 × locator resolved to <div>—</div>
       - unexpected value "—"
