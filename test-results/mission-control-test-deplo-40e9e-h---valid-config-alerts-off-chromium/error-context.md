...
- Name: mission-control-test.spec.ts >> deploy config - happy path - valid config, alerts off
...
Call log:
  ...
  - waiting for locator('div').filter({ hasText: /^Service Name$/ }).locator('xpath=following-sibling::div[1]')
    14 × locator resolved to <div>us-east-1</div>
       - unexpected value "us-east-1"
...
Expected: "us-east-1"
Received: "checkoutservice"
Timeout:  5000ms

Call log:
  - Expect "soft toHaveText" with timeout 5000ms
  - waiting for locator('div').filter({ hasText: /^Region$/ }).locator('xpath=following-sibling::div[1]')
    14 × locator resolved to <div>checkoutservice</div>
       - unexpected value "checkoutservice"
...
Received: "2026-09-01T09:00"
Timeout:  5000ms

Call log:
  - Expect "soft toHaveText" with timeout 5000ms
  - waiting for locator('div').filter({ hasText: /^Deployment Window$/ }).locator('xpath=following-sibling::div[1]')
    14 × locator resolved to <div>2026-09-01T09:00</div>
       - unexpected value "2026-09-01T09:00"

```

```yaml
- text: 2026-09-01T09:00
```
